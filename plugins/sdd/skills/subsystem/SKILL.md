...
request to check a document produces findings; it does not authorize fixes.
...
behavior. A branch that changes an undocumented interaction creates its
document. No document change is a normal result when the claims remain accurate.
