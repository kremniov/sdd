...
start, require the preparation implementation commit to include T-42 inprogress
in the queue. File edit order within the step is not a criterion. Create
...
Supply the input only after that gate. On resume require the implementation-step
commit to include the inprogress update, preserve
